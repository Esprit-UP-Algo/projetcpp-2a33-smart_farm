...
bool Employe::modifier() {
    ...
    //int  Telephone_EM, Age_EM, Salaire_EM, NbAnsFidelite;
     query.prepare("UPDATE EMPLOYES SET ID_EM=:Id_EM, NOM_EM=:Nom_EM, PRENOM_EM=:Prenom_EM, EMAIL_EM=:Email_EM, AGE_EM=:Age_EM,"
                   " TEL_EM=:Telephone_EM, DISPO_EM=:Etat_EM, PASSE=:Motpasse_EM , NB_ANS=:nbAnsFidelite,SALAIRE_EM=:Salaire_EM WHERE ID_EM=:Id_EM");
