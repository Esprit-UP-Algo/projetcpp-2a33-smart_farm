...
ageStatisticsChartView = nullptr;
 ...
 /////////////////////////////MARZOUK///////////////////////////////
      ...
      ui->lineEdit_20->setValidator(new QIntValidator(0,999999,this));
...
void MainWindow::on_miseajour1_clicked()
{
      ...
      QString  Email=ui->EMAIL1->text();
        ...
        int  Tel=ui->TEL1->text().toInt();
         QString Etat=ui->ETAT1->text();
         QString Passe=ui->PASSE1->text();
        int    Nbans=ui->NB_ANS1->text().toInt();

         int   Sal=ui->SAL1->text().toInt();
       Employe EM( id, Nom,  Prenom,  Email,  Etat,Passe, Tel, Age, Sal, Nbans);
...
void MainWindow::on_pushButton_15_clicked()
{
    ...
    ui->tableView_3->setModel(c.trier_type());
    ui->tableView_3->setModel(afficherAliments());
...
{
    QString id_e_string = ui->id_2->text();
            bool ok;
