    ...
    ui(new Ui::video)
{
    ui->setupUi(this);
       ...
       player = new QMediaPlayer(this);//`QMediaPlayer` est utilisé pour lire le fichier vidéo
        vw = new QVideoWidget(this);// `QVideoWidget` est utilisé pour afficher la vidéo
