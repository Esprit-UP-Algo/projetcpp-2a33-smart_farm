...
public:
    ...
    void setNom_EM(QString Nom){Nom_EM=Nom;}
    void setPrenom_EM(QString Prenom){Prenom_EM=Prenom;}
    void setEmail_EM(QString Email){Email_EM=Email;}
    void setEtat_EM(QString Etat){Etat_EM=Etat;}
    void setAge_EM(int Age){Age_EM=Age;}
    void setId_EM(QString Id){Id_EM=Id;}
    void setTelephone_EM(int Telephone){Telephone_EM=Telephone;}
    void setNbAnsFidelite(int NbAnsFId_EMelite) { NbAnsFidelite = NbAnsFId_EMelite; }
      void setSalaire_EM(int Salaire) { Salaire_EM = Salaire; }
